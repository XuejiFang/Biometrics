...
sys.path.append('../WSB2022-assignment')
...
parser.add_argument('--model', '-m', type=str, default='./models/handpose_estimation_mediapipe_2022may.onnx',
...
if __name__ == '__main__':
    # palm detector
    palm_detector = MPPalmDet(modelPath='../WSB2023-assignment/models/palm_detection_mediapipe_2022may.onnx',
                              nmsThreshold=0.3,
                              scoreThreshold=0.8,
